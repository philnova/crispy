...
experimentally-determined array of mismatch penalties. The aggregate score is also multiplied by (1/n^2)^n,
where n is the number of mismatches; this serves as a damping penalty for highly mismatched sequences.
Finally, the aggregate score is multiplied by the mean pairwise distance between mismatch sites, raised
to the nth power. Thus two adjacent mismatches are considered less 'risky' than two distant mismatches.
"""
